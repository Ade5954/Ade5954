## Hi there 👋
### A 6-year developer based in Guangzhou, fluent in Java, Python, TypeScript, and performance tuning.

I code with Claude Code and run Hermes Agent as a personal assistant.  
My main work builds the data backbone for customer-profile CDP systems — from event tracking and user-journey tracing to ad attribution and end-to-end distributed tracing, all on top of big-data analysis.
...
- 🤖 **[hermes-agent](https://github.com/NousResearch/hermes-agent/commits/main/?author=ade5954)**
